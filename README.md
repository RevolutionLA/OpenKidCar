...
一屏显示：环形速度仪表、油门/刹车竖向长杆（转向联动转向灯）、档位、8 功能键、电量/电压/电流/温度/GPS、灯光状态排、事件日志。

### 📱 家长端（http://localhost:8001，手机友好）

<img src="media/images/家长端仿真.png" alt="家长端仿真界面" width="42%">

手机一屏监护：GPS 实时轨迹地图、电量监控、视频通话（按需显示窗格）、对讲机、远程急刹。

**演示效果**：孩子说"打开大灯"，AI 语音识别 → 大脑决策 → 协议 → 小脑执行 LED 亮起；家长在手机上可实时看到 GPS 位置、远程急刹、语音对讲、视频画面。
