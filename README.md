...
## 一个父亲借助 AI，为孩子打造的开源智能儿童电动车平台

> 不只是买一辆玩具车，而是亲手创造一段童年记忆。
...
> 曾经有一个爸爸，在人工智能时代，尝试用自己的双手创造一些东西。
...
想要参与？请先阅读 [贡献指南](CONTRIBUTING.md) 与 [行为准则](CODE_OF_CONDUCT.md)。
...
如果后续希望限制衍生作品也必须开源，可以考虑将软件部分切换为 GPL-3.0；硬件设计部分也可以单独采用 CERN-OHL-S 等硬件开源许可证。
